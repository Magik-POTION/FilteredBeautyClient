...
function DetailsScreen({navigation}) {
    return(
        <View style={{flex: 1, alignItems: 'center', justifyContent: 'center'}}>
            ...
            /* Fetching param from the other screen */
            /* Avoid passing params that is used by multiple screen, should be in GLOBAL store */
    ...
    return (
        <NavigationContainer>
            <Stack.Navigator>
                ...
                <Stack.Screen name="SkinProfile" component={SkinProfileScreen} options={{title: "SkinProfile"}}/>
